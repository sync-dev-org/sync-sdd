...
2. **Steering Context**:
   ...
   - Read `{{SDD_DIR}}/project/steering/tech.md` - Technical constraints, patterns
   - Read `{{SDD_DIR}}/project/steering/structure.md` - Project structure, conventions
...
issues:
  - id: "F1"
    ...
    detail: "Missing error return type for invalid token"
  ...
  - id: "F2"
    ...
    detail: "Undefined transition from expired→refreshing"

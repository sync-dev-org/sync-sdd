...
**Auto-draft policy**: Auto-draft handover.md only at wave completion (all specs in wave design-reviewed) and pipeline completion. Skip at individual spec phase completions (same as run.md dispatch loop policy).

...
- CPF files (read all 4):
  - `__SCOPE_DIR__/active/agent-1-flow.cpf`
  - `__SCOPE_DIR__/active/agent-2-changes.cpf`
  - `__SCOPE_DIR__/active/agent-3-consistency.cpf`
  - `__SCOPE_DIR__/active/agent-4-compliance.cpf`
- Decision history: `__SDD_DIR__/handover/decisions.md`
...
For each finding, search `__SDD_DIR__/handover/decisions.md` for matching entries:
...
Write the consolidated report to: `__SCOPE_DIR__/active/report.md`
...
Write verdict summary to: `__SCOPE_DIR__/active/verdict-data.txt`
...
WRITTEN:__SCOPE_DIR__/active/report.md
```

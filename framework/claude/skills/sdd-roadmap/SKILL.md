...
$ARGUMENTS = "revise {feature} [instructions]" → Revise Mode (Single-Spec) — feature matches known spec name
$ARGUMENTS = "revise [instructions]"             → Revise Mode (Cross-Cutting) — no spec name match

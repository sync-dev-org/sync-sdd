...
3. **Steering Context**:
   ...
   - Read `{{SDD_DIR}}/project/steering/tech.md` - Technical patterns
...
issues:
  - id: "F1"
    ...
    detail: "Design: (config: Config) actual: (config: Config, debug: bool)"
  ...
  - id: "F2"
    ...
    detail: "create_app() called with 0 args, needs 1"

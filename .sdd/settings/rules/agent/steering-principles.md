...
- Detailed documentation of `.sdd/` metadata directories (settings, project)
...
- Light references to `.sdd/project/specs/` and `.sdd/project/steering/` are acceptable; avoid other `.sdd/` internal directories

...
agent-frontmatter-fields: OK (cached from B7)
agent-model-values: OK (cached from B7)
skill-frontmatter-fields: OK (cached from B7)
dispatch-existing-agent-definitions: OK (cached from B7)
general-purpose-built-in-agent: OK (cached from B7)
settings-permission-format: OK (cached from B7)
settings-agent-skill-entry-match: OK (cached from B7)
tool-availability-names: OK (cached from B7)
...
## Output Instructions
1. Write CPF to: .sdd/project/reviews/self-ext/active/agent-4-compliance.cpf
   SCOPE:agent-4-compliance
...
2. After writing, print to stdout:
   ...
   WRITTEN:.sdd/project/reviews/self-ext/active/agent-4-compliance.cpf

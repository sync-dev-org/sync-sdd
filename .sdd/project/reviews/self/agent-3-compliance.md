...
agent-frontmatter-model: OK (cached from B38)
agent-frontmatter-tools: OK (cached from B38)
agent-frontmatter-description: OK (cached from B38)
skills-frontmatter-description-and-allowed-tools: OK (cached from B38)
skills-frontmatter-argument-hint-format: OK (cached from B38)
dispatch-subagent-type-to-existing-agents: OK (cached from B38)
settings-permission-format-skill-agent: OK (cached from B38)
settings-skill-agent-entries-vs-files: OK (cached from B38)
agent-tool-availability-vs-declared-tools: OK (cached from B38)

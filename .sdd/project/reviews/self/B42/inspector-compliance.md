...
agent-frontmatter-model: OK (cached from B41)
agent-frontmatter-tools: OK (cached from B41)
agent-frontmatter-description: OK (cached from B41)
agent-tool-subagent-type-general-purpose: OK (cached from B41)
agent-tool-params-model-run_in_background: OK (cached from B41)
settings-permission-format: OK (cached from B41)
settings-skill-permission-syntax: OK (cached from B41)
settings-agent-skill-entries-match-files: OK (cached from B41)

...
- CPF files (read all 4):
  - `.sdd/project/reviews/self-ext/active/agent-1-flow.cpf`
  - `.sdd/project/reviews/self-ext/active/agent-2-changes.cpf`
  - `.sdd/project/reviews/self-ext/active/agent-3-consistency.cpf`
  - `.sdd/project/reviews/self-ext/active/agent-4-compliance.cpf`
...
Write the consolidated report to: `.sdd/project/reviews/self-ext/active/report.md`

Use this format:

```markdown
# SDD Framework Self-Review Report (External Engine)
**Date**: {current date ISO-8601} | **Engine**: codex [gpt-5.3-codex-spark] | **Agents**: 4 dispatched, {N completed} completed
...
Write verdict summary to: `.sdd/project/reviews/self-ext/active/verdict-data.txt`
...
WRITTEN:.sdd/project/reviews/self-ext/active/report.md
```

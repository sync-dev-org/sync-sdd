...
agent-frontmatter-fields: OK (cached from B10)
agent-model-values: OK (cached from B10)
skills-frontmatter-description-allowed-tools-argument-hint: OK (cached from B10)
settings-permission-format: OK (cached from B10)
settings-agent-skill-entry-match: OK (cached from B10)
tool-availability-names: OK (cached from B10)
agent-tool-parameters-subagent_type: OK (cached from B10)

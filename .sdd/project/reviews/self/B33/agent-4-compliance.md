...
agent-frontmatter-fields: OK (cached from B9)
agent-model-values: OK (cached from B9)
skills-frontmatter-description-allowed-tools-argument-hint: OK (cached from B9)
settings-permission-format: OK (cached from B9)
settings-agent-skill-entry-match: OK (cached from B9)
tool-availability-names: OK (cached from B9)

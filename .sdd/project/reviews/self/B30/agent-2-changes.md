...
- tmux-integration.md: MultiView Layout v2 (4象限12スロット、1-Lead専用化、multiview-grid.sh)
- sdd-review-self-ext SKILL.md: テンプレート化 (per-agent プロンプトを templates/ + sed 置換に移行)
- templates/review-self-ext/: 4 Agent テンプレート新設 (agent-1〜4)
- install.sh: scripts/ ディレクトリ追加 (install/uninstall/stale/help)
- settings.json + CLAUDE.md + run.md + review.md: B5/B6 review fixes

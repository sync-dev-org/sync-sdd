...
agent-frontmatter-fields: OK (cached from B6)
agent-model-values: OK (cached from B6)
skill-frontmatter-fields: OK (cached from B6)
settings-permission-format: OK (cached from B6)
tool-availability-names: OK (cached from B6)
general-purpose-built-in-agent: OK (cached from B6)

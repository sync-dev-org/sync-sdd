...
全 retroactive spec 更新完了。コミット待ち。

### Active Goals
- [x] Retroactive spec 更新 — v0.18.2 (コンテキスト漏洩防止) + v0.19.0 (E2E Inspector) の変更を既存 spec に反映
...
### Modified Files
- `.claude/sdd/project/specs/design-review/design.md` (v1.3.0)
- `.claude/sdd/project/specs/design-review/spec.yaml`
- `.claude/sdd/project/specs/impl-review/design.md` (v1.2.0)
- `.claude/sdd/project/specs/impl-review/spec.yaml`
- `.claude/sdd/project/specs/dead-code-review/design.md` (v1.3.0)
- `.claude/sdd/project/specs/dead-code-review/spec.yaml`
- `.claude/sdd/project/specs/roadmap-orchestration/design.md` (v1.2.0)
- `.claude/sdd/project/specs/roadmap-orchestration/spec.yaml`

## Resume Instructions
1. `session.md` を読み込み、Direction を確認
2. 全 15 spec が implementation-complete であることを `/sdd-status` で確認
3. 残作業がなければ次のフィーチャー開発または `/sdd-handover` でセッション終了
